...
const title = "Спартак";
const description =
  "В центре повествования романа — гладиатор Спартак, реальный исторический персонаж, возглавивший восстание рабов в Древнем Риме ";
const authors = "Рафаэлло Джованьоли";
